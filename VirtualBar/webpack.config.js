...
Encore.addEntry('login', './resources/js/cadastro/login.js')
Encore.addEntry('cadastro', './resources/js/cadastro/cadastro.js')
Encore.addEntry('profile', './resources/js/Profile/profile.js')
/*
|--------------------------------------------------------------------------
| Copy assets
|--------------------------------------------------------------------------
